...
{
    static class ConexionMysqlRemota
    {

        private static MySqlConnection conexionRemota;
        //private static MySqlConnection conexion;
        private static MySqlTransaction transaccionglobalRemota;
        public static string msjError2 = "Error";
        ...
        public static Boolean conecta()
        {
            ...
            {
                MessageBox.Show("Error al conectar con la base de datos ->" + ex.Message, msjError2, MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        }
        ...
        public static Boolean cierraConexion()
        {
            ...
            {
                MessageBox.Show("Error al cerrar la conexion con la base de datos ->" + ex.Message, msjError2, MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        }
        ...
        public static Boolean insUpd(string consultasql)
        {
            try
            {
                ...
                comando.Connection = conexionRemota;
                comando.ExecuteNonQuery();
                return true;
            }
            catch (MySqlException ex)
            {
                MessageBox.Show("Error al ejecutar insUpd(..)->" + ex.Message, msjError2, MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        }
        ...
        public static Boolean insUpdImagen(string nombreProc, string nombreParametros, string valorParametros, string nombreParametroImagen, string nombreParametroImagen2, byte[] imagen, byte[] imagen2)
        {
            ...
            {
                MessageBox.Show("Error al ejecutar insUpdImagen(..)->" + ex.Message, msjError2, MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        }
        ...
        public static void llenaDataset(ref DataSet datos, string sql, string tabla)
        {
            ...
            {
                MessageBox.Show("Error al ejecutar la consulta llenaDataset(..) ->" + ex.Message, msjError2, MessageBoxButtons.OK, MessageBoxIcon.Error);
               // return dt;
            }
        }
        ...
        public static void llenaDataTable(ref DataTable tabla,string sql)
        {
            ...
            {
               MessageBox.Show("Error al ejecutar la consulta llenaDataTable(..) ->" + ex.Message, msjError2, MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        public static string regresaCampoConsulta(string sql)
        {
            ...
            {
                MessageBox.Show("Error al ejecutar la consulta regresaCampoConsulta(..) ->" + ex.Message, msjError2, MessageBoxButtons.OK, MessageBoxIcon.Error);
                return "";
            }
        }
        ...
        public static string insUpd_transaccion(string sql)
        {
            try
            {
                if (transaccionglobalRemota == null)
                {
                    transaccionglobalRemota = conexionRemota.BeginTransaction();
                }
                MySqlCommand comando = new MySqlCommand();
                comando.Connection = conexionRemota;
                comando.CommandText = sql;
            ...
            {
                transaccionglobalRemota.Rollback();
                transaccionglobalRemota = null;
                MessageBox.Show("Error al ejecutar insUpd_transaccion(..) ->" + ex.Message, msjError2, MessageBoxButtons.OK, MessageBoxIcon.Error);
                return "Error";
            }
        }
        ...
        {
            try{
                transaccionglobalRemota.Commit();
                transaccionglobalRemota = null;
            }
            catch(MySqlException ex){
                MessageBox.Show("Error al ejecutar transCompleta(..) ->" + ex.Message, msjError2, MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        public static void transErronea()
        {
            ...
            {
                MessageBox.Show("Error al ejecutar transErronea(..) ->" + ex.Message, msjError2, MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        public static string insUpd_regresavalor(string sql)
        {
            ...
            {
                MessageBox.Show("Error al ejecutar insUpd_regresavalor(..) ->" + ex.Message, msjError2, MessageBoxButtons.OK, MessageBoxIcon.Error);
                return "Error";
            }
        }
        ...
        public static void llenaCombo(ref ComboBox cmb, string sql, string valuemember, string displaymember)
        {
            ...
            try
            {
                MySqlDataAdapter adaptador = new MySqlDataAdapter(sql, conexionRemota);
                adaptador.Fill(dts);
            ...
            {
                MessageBox.Show("Error al llenar llenaCombo(..) ->" + ex.Message, msjError2, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dts = null;
            }
        }
    }
