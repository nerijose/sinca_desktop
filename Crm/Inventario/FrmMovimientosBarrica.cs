...
{
    public partial class FrmMovimientosBarrica : Form
    {
        public FrmMovimientosBarrica()
        {
            InitializeComponent();
        }
        ...
        private void FrmMovimientosBarrica_Load(object sender, EventArgs e)
        {
            addTablaTanques();
            string clase;
           ...
           //calcula los meses y los años entre dos fechas
            ...
            {
                clase = "Añejo";
                timeinBarricas = Convert.ToString(AntAños)+" Año(s)";
            }
            else if (AntMeses>=2)
            {
                clase="Reposado";
                timeinBarricas = Convert.ToString(AntMeses)+" Meses";
            }
            else
            {
                clase = "Blanco o Joven";
                timeinBarricas = Convert.ToString(AntMeses)+" Mes";
            }
            ...
            LblAbocante.Text = timeinBarricas;
            LblLitros.Text = litros;
            LblGradoAlcoholico.Text = grado_alcoholico;
            LblNoBarricas.Text = no_barricas;
        }
        ...
        //con el boton que se guarda de barricas a granel
        private void BtnGuardarBarricaAGranel_Click(object sender, EventArgs e)
        {
            double extraccion_litros_mermas;
            ...
            if (TxtLitrosMerma.Text == "")
            {
                TxtLitrosMerma.Text = "0";
            }
            if (TxtLitrosMerma.Text == ".")
            {
                MessageBox.Show("Debe introducir una merma real ");
                TxtLitrosMerma.Focus();
                return;
            }

            if (txtNbarricas.Text == "") {

                MessageBox.Show("Debe introducir un número de barricas a liberar...");
            }


            extraccion_litros_mermas = Math.Round(double.Parse(TxtLitrosMerma.Text), 2) + Math.Round(double.Parse(TxtLitros.Text), 2);

            if (extraccion_litros_mermas > double.Parse(litros))
            {
            ...
            else
            {
                ...
                if (tipo == "fabrica")
                {
                    ...
                    else
                    {
                        ...
                        foreach (DataRow row in Datos2.Tables[0].Rows)
                        {
                            ...
                            if (ConexionMysql.insUpd_transaccion("INSERT INTO  granel_ensamble(id_granel_ensamble,id_granel_entrada,id_comun,id_planta,id_predio,litros,agave_coccion_kg,id_verificador,actualizado) VALUES('" + id_max_granel_ensamble + "','" + id_max_granel_entrada + "'," + id_comun + "," + id_planta + ",'" + id_predio + "'," + litros2 + "," + agave_coccion_kg + "," + Usuario.IdUsuario + ",0 )") == "Error")
                            {
                                return;
                            }
                    ...
                    if (ConexionMysql.insUpd_transaccion("INSERT INTO  granel_movimientos(id_granel_movimientos,id_granel_entrada,id_gran_mov_salio,tipo,destino,litros,grado_alcoholico,merma_litros,fecha,fecha_movimiento,actualizado,id_verificador) VALUES('" + id_max_granel_movimientos + "', '" + id_max_granel_entrada + "','" + id_granel_movimiento + "','entrada','granel-barricas' , " + TxtLitros.Text + "," + TxtGradoAlcoholico.Text + "," + TxtLitrosMerma.Text + ",now(),NOW(), 0," + Usuario.IdUsuario + ")") == "Error")
                    {
                        return;
                    }

                    if (ConexionMysql.insUpd_transaccion("UPDATE granel_movimientos SET litros_existentes=ROUND(litros_existentes-" + extraccion_litros_mermas + ",2), numero_de_contenedores=ROUND(numero_de_contenedores-" + txtNbarricas.Text + ",2),actualizado=0 where id_granel_movimientos='" + id_granel_movimiento + "'  ") == "Error")
                    {
                        return;
                    }
                ...
                else if (tipo == "almacen")
                {
                    ...
                    else
                    {
                        ...
                        foreach (DataRow row in Datos2.Tables[0].Rows)
                        {
                            ...
                            if (ConexionMysql.insUpd_transaccion("INSERT INTO  almacen_granel_ensamble(id_almacen_granel_ensamble,id_almacen_granel_entrada,id_comun,id_planta,id_predio,litros,agave_coccion_kg,id_verificador,actualizado) VALUES('" + id_max_almacen_granel_ensamble + "','" + id_max_almacen_granel_entrada + "'," + id_comun + "," + id_planta + "," + id_predio + "," + litros2 + "," + agave_coccion_kg + "," + Usuario.IdUsuario + ",0 )") == "Error")
                            {
                                return;
                            }
                    ...
                    if (ConexionMysql.insUpd_transaccion("INSERT INTO  almacen_granel_movimientos(id_almacen_granel_movimientos,id_almacen_granel_entrada,id_almacen_gran_mov_salio,tipo,destino,litros,grado_alcoholico,merma_litros,fecha,fecha_movimiento,actualizado,id_verificador) VALUES('" + id_max_almacen_granel_movimientos + "', '" + id_max_almacen_granel_entrada + "','" + id_granel_movimiento + "','entrada','granel-barricas' , " + TxtLitros.Text + "," + TxtGradoAlcoholico.Text + "," + TxtLitrosMerma.Text + ",now(),NOW(), 0," + Usuario.IdUsuario + ")") == "Error")
                    {
                        return;
                    }

                    if (ConexionMysql.insUpd_transaccion("UPDATE almacen_granel_movimientos SET litros_existentes=ROUND(litros_existentes-" + extraccion_litros_mermas + ",2), numero_de_contenedores=ROUND(numero_de_contenedores-" + txtNbarricas.Text + ",2),actualizado=0 where id_almacen_granel_movimientos='" + id_granel_movimiento + "'  ") == "Error")
                    {
                        return;
                    }
                ...
                {  
                    ...
                    else
                    {
                        ...
                        foreach (DataRow row in Datos2.Tables[0].Rows)
                        {
                            ...
                            if (ConexionMysql.insUpd_transaccion("INSERT INTO  granel_ensamble_envasado(id_granel_ensamble,id_granel_entrada_envasado,id_comun,id_planta,id_predio,litros,agave_coccion_kg,id_verificador,actualizado) VALUES('" + id_max_granel_ensamble_envasado + "','" + id_max_granel_entrada_envasado + "'," + id_comun + "," + id_planta + ",'" + id_predio + "'," + litros2 + "," + agave_coccion_kg + "," + Usuario.IdUsuario + ",0 )") == "Error")
                            {
                                return;
                            }
                    ...
                    if (ConexionMysql.insUpd_transaccion("INSERT INTO  granel_movimientos_envasado(id_granel_movimientos_envasado,id_granel_entrada_envasado,id_gran_mov_salio,tipo,destino,litros,grado_alcoholico,merma_litros,fecha,fecha_movimiento,actualizado,id_verificador) VALUES('" + id_max_granel_movimientos_envasado + "', '" + id_max_granel_entrada_envasado + "','" + id_granel_movimiento + "','entrada','granel-barricas' , " + TxtLitros.Text + "," + TxtGradoAlcoholico.Text + "," + TxtLitrosMerma.Text + ",now(),NOW(), 0," + Usuario.IdUsuario + ")") == "Error")
                    {
                        return;
                    }

                    if (ConexionMysql.insUpd_transaccion("UPDATE granel_movimientos_envasado SET litros_existentes=ROUND(litros_existentes-" + extraccion_litros_mermas + ",2),numero_de_contenedores=ROUND(numero_de_contenedores-" + txtNbarricas.Text + ",2),actualizado=0 where id_granel_movimientos_envasado='" + id_granel_movimiento + "'  ") == "Error")
                    {
                        return;
                    }
                ...
                MessageBox.Show("Liberacion realizada con éxito");
                this.Close();
        ...
        {
            if (TxtLitros.Text == "0" || TxtLitros.Text == "" || TxtLitros.Text == ".")
            {
                TxtLitrosMerma.Text = "";
            }
            else
            {
            double resultado = Math.Round(double.Parse(litros), 2) - Math.Round(double.Parse(TxtLitros.Text), 2);
            if (resultado <= 0)
            {
                TxtLitrosMerma.Text = "0";
            }
            ...
            {
                TxtLitrosMerma.Text = resultado.ToString();
            }
            }
        ...
        private void TxtLitrosMerma_KeyPress(object sender, KeyPressEventArgs e)
        {
            valida.numeroPunto(e, TxtLitrosMerma.Text);
        }
        ...
        private void txtNbarricas_KeyPress(object sender, KeyPressEventArgs e)
        {
            valida.numeroPunto(e, TxtLitrosMerma.Text);
        }
