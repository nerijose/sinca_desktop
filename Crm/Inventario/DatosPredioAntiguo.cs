...
{
    public partial class DatosPredioAntiguo : Form
    {
        public DatosPredioAntiguo()
        {
            InitializeComponent();
        }
